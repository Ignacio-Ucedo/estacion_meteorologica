# station-switcher/spec.md

# Station Switcher Specification

## Purpose

Permite al usuario cambiar la estación activa desde cualquier punto de entrada del dashboard (chip del Topbar o StationPanel). La selección persiste entre sesiones mediante `localStorage`. El Dashboard y la sección de Gráficas reaccionan automáticamente al cambio de estación.
