...
Especificación del sistema de toasts para notificaciones de errores en operaciones de background, incluyendo la infraestructura de contexto React y el comportamiento de auto-dismiss.
